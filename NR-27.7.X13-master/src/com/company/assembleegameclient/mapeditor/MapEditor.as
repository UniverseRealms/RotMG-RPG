...
public class MapEditor extends Sprite {
    ...
    private function onMapTest(_arg1:MapTestEvent):void {
        ...
        this.gameSprite_ = new GameSprite(this.server, Parameters.MAPTEST_GAMEID, false, this.model.getSavedCharacters()[0].charId(),
                -1, null, this.model, _arg1.mapJSON_, false);
