package Market.ui
{
   ...
   public class MarketMyOffersScreen extends Sprite
   {
      ...
      private var scrollBar:com.company.assembleegameclient.ui.Scrollbar;
      ...
      private function onResult(param1:String, param2:Boolean) : void
      {
         ...
         dialog = new Dialog(!!error?"Ooops :C":"Success",message,"Ok",null,"/marketResult");
...
class OfferEntry extends Sprite
{
   ...
   function OfferEntry(param1:PlayerShopItem)
   {
      ...
      var _loc3_:String = !!ObjectLibrary.parseFromXML[param1.itemId].hasOwnProperty("DisplayId")?ObjectLibrary.parseFromXML[param1.itemId].DisplayId:ObjectLibrary.parseFromXML[param1.itemId].@id;
   ...
   private function onRollOver(param1:MouseEvent) : void
   {
      ...
      StaticInjectorContext.getInjector().getInstance(ToolTip).dispatch(toolTip);
   }
   ...
   private function onRemoveClick(param1:MouseEvent) : void
   {
      ...
      dialog = new Dialog("Are you sure?",!!this.isLast?"This action cannot be undone, continue?":"This action will cost you 5 fame and cannot be undone, continue?","Remove","Keep it","/removeConfirm");
