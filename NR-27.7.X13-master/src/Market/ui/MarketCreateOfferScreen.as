...
public class MarketCreateOfferScreen extends Sprite
   {
    ...
    public function MarketCreateOfferScreen()
      ...
      private function onSaveOffers(param1:MouseEvent) : void
      {
         ...
         if(!valid)
         {
            dialog = new Dialog("Ooops :C","Some of your offers are not valid, check the price and make sure you gave them an item.","Ok",null,"/offerError");
...
class OfferEntry extends Sprite
{
  ...
  // private var sellSlot:MarketInventorySlot;
   ...
   private function onRemoveClick(param1:MouseEvent) : void
   {
      var dialog:Dialog = null;
      var event:MouseEvent = param1;
      dialog = new Dialog("Confirm","Are you sure you want to remove this offer from your creation list?","Remove","Keep it","/removeConfirm");
   ...
   {
      (param1.target as Dialog).parent.removeChild(param1.target as Dialog);
